      ...
      <div className="container-xlg mb-5 ml-1" id="courses" data-aos="fade-right" style={{ border: "0px solid grey", borderRadius: "5px" }}>
        <section className="section section-default mt-none mb-none section-padding-0-100 clearfix">
          <div className="container-fluid">
            <div className="row align-items-center items" data-aos="zoom-in">
              <div className="col-12 col-lg-10 offset-lg-1 col-md-10 offset-md-1">
                <ul>
                  <h2 className="mb-sm" style={{ textAlign: "center",marginTop:"45px" }}>Quiz For Student</h2><br />
                  ...
                  <center>
                    <Link to="/login"><button className="text-left float-left p-2 text-white bg-primary" fdprocessedid="236p1o">Login To Get Quiz</button></Link>
                  </center>
                </ul>
              </div>
            </div>
